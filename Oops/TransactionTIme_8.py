...
company_tran = json.load(open("transaction.json", "r"))  # opening and reading the 'company' JSON file and
    ...
    while True:
        ...
        try:
            if choice == 1:
                ...
                print()
                q1.show()  # calling 'display' function to print all the element of the Queue
            elif choice == 4:
                print("exited")
